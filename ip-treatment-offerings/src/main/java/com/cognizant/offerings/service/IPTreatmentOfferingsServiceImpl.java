...
import com.cognizant.offerings.controller.IPTreatmentOfferingsController;
...
public class IPTreatmentOfferingsServiceImpl implements IPTreatmentOfferingsService{
	...
	private static final Logger LOGGER= LoggerFactory.getLogger(IPTreatmentOfferingsController.class);
	...
	public List<IPTreatmentPackage> getIPTreatmentPackages() {
		LOGGER.info("START :: Method :: getIPTreatmentPackages() :: ");
		...
		LOGGER.info("END :: Method :: getIPTreatmentPackages() :: ");
	...
	public IPTreatmentPackage getIPTreatmentPackageByAilmentCategoryAndName(String packageName, String category) {
		LOGGER.info("START :: Method :: getIPTreatmentPackageByAilmentCategoryAndName() :: ");
		...
		LOGGER.info("packagedetail{}:", packageDetail);
		LOGGER.info("END :: Method :: getIPTreatmentPackageByAilmentCategoryAndName() :: ");
		return packageDetail;
	}
	...
	public List<SpecialistDetail> getSpecialists() {
		LOGGER.info("START :: Method :: getSpecialists() :: ");
		...
		LOGGER.info("END :: Method :: getSpecialists() :: ");
